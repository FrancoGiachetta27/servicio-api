...
impl TestContext {
    ...
    pub async fn setup_with_migration() -> Self {
    ...
    pub async fn teardown(self) {
        ...
        Migrator::refresh(&self.db).await.ok();
        let _ = &self.db.close().await.ok();
    }

    async fn migrate(&self) {
        // migrar esquemas
        Migrator::up(&self.db, None).await.ok();
        ...
        PersonaEntity::insert_many(personas)
            ...
            .await
            .ok();
        HeladeraEntity::insert_many(heladeras)
            .exec(&self.db)
            .await
            .ok();
    }
