    ...
    async fn setup() -> TestContext {
        ...
        let personas = vec![
            PersonaModel {
                ...
                fecha_nacimiento: Set(NaiveDate::from_ymd_opt(1978, 3, 22).unwrap()),
                direccion_id: Set(Uuid::from_u128(1).into()),
            ...
            PersonaModel {
                ...
                apellido: Set("Perez".into()),
                fecha_nacimiento: Set(NaiveDate::from_ymd_opt(2002, 11, 21).unwrap()),
                direccion_id: Set(Uuid::from_u128(6).into()),
                pariente_a_cargo: Set(None),
            },
            PersonaModel {
                ...
                apellido: Set("Perez".into()),
                fecha_nacimiento: Set(NaiveDate::from_ymd_opt(2003, 5, 3).unwrap()),
                direccion_id: Set(Uuid::from_u128(7).into()),
                pariente_a_cargo: Set(None),
            },
            PersonaModel {
            ...
            PersonaModel {
                ...
                apellido: Set("Perez".into()),
                fecha_nacimiento: Set(NaiveDate::from_ymd_opt(2003, 1, 5).unwrap()),
                direccion_id: Set(Uuid::from_u128(9).into()),
                pariente_a_cargo: Set(None),
            },
            PersonaModel {
                ...
                apellido: Set("Perez".into()),
                fecha_nacimiento: Set(NaiveDate::from_ymd_opt(2002, 12, 2).unwrap()),
                direccion_id: Set(Uuid::from_u128(10).into()),
                pariente_a_cargo: Set(None),
            },
            PersonaModel {
                ...
                apellido: Set("Perez".into()),
                fecha_nacimiento: Set(NaiveDate::from_ymd_opt(2003, 5, 27).unwrap()),
                direccion_id: Set(Uuid::from_u128(11).into()),
                pariente_a_cargo: Set(None),
            },
        ];
